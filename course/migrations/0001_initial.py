    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[('easy', 'easy'), ('middle', 'middle'), ('advanced', 'advanced')], max_length=32)),
                ...
                ('admin_price', models.DecimalField(decimal_places=2, default=0, max_digits=8)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('variant_en', models.CharField(max_length=64, null=True)),
                ('variant_ru', models.CharField(max_length=64, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[('easy', 'easy'), ('middle', 'middle'), ('advanced', 'advanced')], default='easy', max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='course.course')),
                ('students', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='course.student')),
            ],
        ),
        migrations.CreateModel(
            name='TeacherRating',
